                            ...
                            @foreach($events as $event)
                                <div class="border-b pb-6">
                                    ...
                                    <div class="flex mt-4 gap-4">
                                        ...
                                        <a href="{{ route('opinions', $event->id) }}" class="inline-block px-6 py-2 text-white bg-yellow-400 rounded-lg shadow-lg hover:bg-yellow-500 transition-all duration-300 transform hover:scale-105">
                                            Pokaż opinie
                                        </a>
